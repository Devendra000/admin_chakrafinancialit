...
import { Search, Plus, Mail, Phone, DollarSign, MoreHorizontal, Edit, Trash2, Eye } from "lucide-react"
...
const clients = [
  {
    ...
    joinDate: "2024-01-15",
    totalValue: "$125,000",
    services: ["Investment Planning", "Tax Consultation"],
  ...
  },
  {
    ...
    joinDate: "2023-11-08",
    totalValue: "$89,500",
    services: ["Retirement Planning", "Insurance Services"],
          ...
          <DialogContent className="sm:max-w-[600px]">
            ...
            <div className="grid gap-4 py-4">
              ...
              <div className="space-y-2">
                ...
                <Textarea id="notes" placeholder="Add any additional notes about the client" />
              </div>
            </div>
            <DialogFooter>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-gray-600">84.5% of total</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              ...
              <div key={client.id} className="flex items-center justify-between p-4 border rounded-lg hover:bg-gray-50">
                ...
                <div className="flex items-center space-x-4">
                  <div className="text-right">
                    ...
                    <p className="text-sm text-gray-600 mt-1">{client.totalValue}</p>
                  </div>
                  <div className="text-right text-sm text-gray-600">
                    <p>Joined: {new Date(client.joinDate).toLocaleDateString()}</p>
                    <p>Last contact: {new Date(client.lastContact).toLocaleDateString()}</p>
                  </div>
                  <DropdownMenu>
